...
2，[**Python+Selenium+Linux**](https://github.com/ayyayyayy2002/BilibiliAutoReport/tree/Python%2BSelenium%2BLinux)分支：默认分支，**纯Python，浏览器过人机验证，Linux运行**，多账号+关键词搜索+稍后再看+黑白名单  
